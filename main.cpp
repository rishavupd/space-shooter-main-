...
void introScreen()
{
	glClear(GL_COLOR_BUFFER_BIT);
		...
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-425, 490, 0.0,"BANGALORE TECHNOLOGICAL INSTITUTE");
	...
	displayRasterText(-100, 150, 0.0,"created by");
	 ...
	 displayRasterText(-130, 80, 0.0,"SHOOTERS");
	  ...
	  displayRasterText(-800, -100, 0.0," STUDENT NAMES");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0," Rishav Upadhyay");
	displayRasterText(-800, -285, 0.0," Shrishav Adhikari");
	displayRasterText(-800, -370, 0.0," Pasang Dorje Tamang");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Under the Guidance of");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"Mrs. Monica C");
		glColor3f(1.0, 0.0, 0.0);
